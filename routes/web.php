...
Route::middleware('auth')->prefix('admin')->name('admin_')->group(function () {
    ...
    Route::prefix('/homepage-slider')->name('sliders_')->group(function (){
        ...
        Route::post('/enable-slider', [\App\Http\Controllers\Admin\IndexController::class, 'enableSlider'])->name('enable_slider');
        Route::post('/disable-slider', [\App\Http\Controllers\Admin\IndexController::class, 'disableSlider'])->name('disable_slider');
        Route::post('/slider/sort', [\App\Http\Controllers\Admin\IndexController::class, 'sort'])->name('slider_sort');
