...
Route::prefix('/blog')->name('blog_')->group(function () {
    ...
    Route::get('/author', [\App\Http\Controllers\Front\BlogController::class, 'blogAuthor'])->name('author_page');
    Route::get('/category', [\App\Http\Controllers\Front\BlogController::class, 'blogCategory'])->name('category_page');
